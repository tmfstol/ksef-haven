...
function parseKsefXml(xml: string, ksefNumber: string): ParsedInvoice {
...
function generateInvoicePdf(inv: ParsedInvoice): string {
  ...
  y += 2;
  bold(12); black();
  doc.text("Do zapłaty:", totX, y); doc.text(`${inv.totalGross} PLN`, margin + cw, y, { align: "right" });
